...
class EnrichInboxApplicants extends Command
{
    ...
    private function buildMessages(
        ...
        $system = "Du bist ein Datenextraktions-Agent für ein Recruiting-System.\n"
            ...
            . "8. Email-Adresse: Bestimme die persönliche Email-Adresse des Bewerbers.\n"
            . "   Vergleiche dazu die Absender-Adresse (from) mit Adressen im Email-Body/Lebenslauf.\n"
            . "   Die persönliche Adresse ist die, die dem Bewerber selbst gehört — NICHT die des Portals/Systems.\n"
            ...
            . "- Suche im Email-Body (text_body) und in Anhängen nach der echten Email-Adresse des Bewerbers.\n"
            . "- Lege am CRM-Kontakt NUR die persönliche Email des Bewerbers als primäre Adresse an.\n"
            . "- Lege KEINE System-/Portal-Absender-Adressen am CRM-Kontakt an.\n"
            . "- Pro Bewerber: Maximal EINE Email-Adresse — die persönliche, primäre.\n\n"
            . "WICHTIG:\n"
