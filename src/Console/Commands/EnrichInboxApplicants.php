...
class EnrichInboxApplicants extends Command
{
    ...
    private function buildMessages(
        ...
        $system = "Du bist ein Datenextraktions-Agent für ein Recruiting-System.\n"
            ...
            . "   - Format: {\"fields\": {\"feldkey\": \"wert\", ...}} — nutze die Keys aus core.extra_fields.GET.\n"
            ...
            . "8. Falls eine PERSÖNLICHE Email-Adresse des Bewerbers gefunden (z.B. im Email-Body oder Lebenslauf):\n"
            . "   Lade email_type per crm.lookup.GET, dann crm.email_addresses.POST mit contact_id, email_address, email_type_id, is_primary=true.\n"
            . "   WICHTIG: Lege NUR die persönliche Email des Bewerbers an. KEINE Portal-/System-Adressen\n"
            . "   (z.B. noreply@indeed.com, reply-xyz@ebay-kleinanzeigen.de etc.) — diese gehören NICHT dem Bewerber.\n"
            ...
            . "PORTAL-BEWERBUNGEN:\n"
            . "- Bewerbungen kommen oft über Job-Portale (Indeed, eBay Kleinanzeigen, StepStone, Jobscout24 etc.).\n"
            . "- In diesem Fall ist der Email-Absender NICHT der Bewerber, sondern das Portal (z.B. noreply@indeed.com).\n"
            . "- Die echte Email-Adresse des Bewerbers steht oft IM Email-Body oder in den Anhängen.\n"
            . "- Suche in den Email-Nachrichten (text_body) nach einer persönlichen Email-Adresse des Bewerbers.\n"
            . "- Wenn du eine findest: Lege NUR DIESE als primäre Email am CRM-Kontakt an per crm.email_addresses.POST "
            . "(contact_id, email_address, is_primary=true).\n"
            . "- Lege NIEMALS die Portal-Absender-Adresse als Email am CRM-Kontakt an!\n"
            . "  Erkennungsmerkmale von Portal-Adressen: noreply@, reply-*@, notification@, *@indeed.com,\n"
            . "  *@ebay-kleinanzeigen.de, *@stepstone.de, *@jobscout24.de, *@monster.de und ähnliche.\n"
            . "- Pro Bewerber: Lege maximal EINE Email-Adresse an — die persönliche, primäre.\n\n"
            . "WICHTIG:\n"
