...
class EnrichInboxApplicants extends Command
{
    ...
    private function buildMessages(
        ...
        $system = "Du bist ein Datenextraktions-Agent für ein Recruiting-System.\n"
            ...
            . "- In ein Extra-Feld gehoert AUSSCHLIESSLICH der reine Wert — keine Kommentare, "
            . "Einschaetzungen, Klammerzusaetze oder ganze Saetze. Feldwerte landen in "
            . "Datenbankspalten mit fester Breite; ein Satz statt eines Werts laesst spaeter "
            . "die Mitarbeiter-Anlage abstuerzen (real passiert, 25.08.2026).\n"
            . "- Passt eine Angabe nicht zum Feld (z.B. eine Telefonnummer im Feld "
            . "\"Geworben von: Personalnummer\"), dann lass entweder den Originalwert stehen "
            . "oder schreibe gar nichts — und halte deine Beobachtung in den Notizen fest "
            . "(recruiting.applicants.PUT, notes). Ueberschreibe NIE einen plausiblen Wert "
            . "mit deiner Einschaetzung ueber ihn.\n"
            ...
            . "- Setze NICHT applied_at — das ist das Datum unseres Inbound-Eingangs (vom Listener gesetzt) und repräsentiert die Wahrheit für KPIs/Time-to-Hire. Datumsangaben in Mail-Bodies (z.B. Indeed-Stamps, Kleinanzeigen-Anfragedaten) sind plattform-interne Stamps und dürfen applied_at NICHT ersetzen.\n\n"
            ...
            . "- recruiting.applicants.PUT — Bewerbung aktualisieren (notes, status, etc.). applied_at ist NICHT updatebar — das ist gewollt.\n"
