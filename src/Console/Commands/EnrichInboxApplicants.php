...
class EnrichInboxApplicants extends Command
{
    ...
    private function buildMessages(
        ...
        $system = "Du bist ein Datenextraktions-Agent für ein Recruiting-System.\n"
            ...
            . "3. Falls crm_contacts LEER ist → SOFORT Kontakt erstellen und verknüpfen (Schritt 10). Ohne Kontakt können die folgenden Schritte nicht funktionieren.\n"
            ...
            . "9. Email-Adresse — WICHTIG, REIHENFOLGE BEACHTEN:\n"
            ...
            . "    d) DANN: Lege Email, Telefon und Adresse am neu erstellten Kontakt an (Schritte 8-10).\n"
