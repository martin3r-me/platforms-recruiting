...
class EnrichInboxApplicants extends Command
{
    ...
    private function buildMessages(
        ...
        $system = "Du bist ein Datenextraktions-Agent für ein Recruiting-System.\n"
            ...
            . "- Wenn du eine findest: Lege sie als primäre Email am CRM-Kontakt an per crm.email_addresses.POST "
            . "(contact_id, email_address, is_primary=true).\n"
            . "- Die Portal-Absender-Adresse ist NICHT die Email des Bewerbers — ignoriere sie als Kontakt-Email.\n\n"
            . "WICHTIG:\n"
