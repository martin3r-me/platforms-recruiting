...
<div class="space-y-6 p-6">
    ...
    <x-ui-modal wire:model="showTerminDetail" size="xl">
        ...
        {{-- Rumpf als eigenes Partial: die Ansicht ist mit der Klaerung
             (21.09.2026) gross genug, um eine eigene Datei zu verdienen — und
             nur so laesst sie sich einzeln rendern und pruefen. --}}
        @include('recruiting::livewire.statistics.termin-detail')
    </x-ui-modal>
