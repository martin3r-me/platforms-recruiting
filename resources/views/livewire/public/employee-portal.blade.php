                                ...
                                <div class="flex items-start justify-between gap-4">
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="mt-2 text-xs">
                                            {{-- Der issued-Zweig steht VOR der Unterschrieben-Bedingung, und das ist
                                                 Pflicht, keine Stilfrage: die Zertifikat-Zeile traegt signed_at (das
                                                 Ausstellungsdatum), gewinnt also die Bedingung darunter und behauptete
                                                 „Unterschrieben am ..." ueber ein Dokument, das niemand unterschrieben
                                                 hat. Gemessen an der gerenderten Blade in PortalCertificateBadgeTest. --}}
                                            @if($c['status'] === 'issued')
